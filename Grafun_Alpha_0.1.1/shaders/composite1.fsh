...
vec3 sun_base_color=vec3(1,1,1)*sunlight_k;
...
float skylight_k=1;
if(sun_theta_c<0)skylight_k=clamp(pow(pow(sun_theta_s,65),2),0.08,1); 
	vec3 skylight=realsky*skylightColor*skylight_k;
